        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul class="nav">
                <li class="submenu">
                    ...
                    <ul>
                        <li><a href="{{ route('admin.home') }}" ><img src="{{ URL::asset('/assets/img/icons/dashboard.svg')}}" alt="img"><span> Dashboard</span> </a></li>
                        <li class="submenu">
        ...
        <div id="sidebar-menu" class="sidebar-menu">
            ...
            <div class="tab-content tab-content-four pt-2">
                ...
                <ul class="tab-pane" id="messages" aria-labelledby="messages-tab">
                    <li><a href="{{ route('manageusers.create')}}">New User </a></li>
                    <li><a href="userlists">Users List</a></li>
                </ul>
            ...
            <ul>
                <li class="submenu-open">
                    ...
                    <ul>
                        <li class="{{ Request::is('index','index-two') ? 'active' : '' }}" >
                            <a href="{{ route('admin.home') }}"><i data-feather="grid"></i><span>Dashboard</span></a>
                        </li>
                    </ul>								
                </li>
                <li class="submenu-open">
                ...
                <li class="submenu-open">
                    ...
                    <ul>
                        <li class="submenu">
                            <a class="{{ Request::is('addAnnouncement','showAnnouncement','updateAnnouncement') ? 'active subdrop' : '' }}" href="javascript:void(0);"><i data-feather="pen-tool"></i></i><span>Announcement</span><span class="menu-arrow"></span></a>
                            <ul>
                                <li><a class="{{ Request::is('addAnnouncement','updateAnnouncement') ? 'active' : '' }}" href="{{ route('manageannouncement.addAnnouncement')}}">New Announcement </a></li>
                                <li><a class="{{ Request::is('show' , 'showAnnouncement') ? 'active' : '' }}" href="{{ route('manageannouncement.showAnnouncement')}}">Announcement List</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>	
