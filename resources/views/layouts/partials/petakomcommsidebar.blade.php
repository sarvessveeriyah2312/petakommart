        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul class="nav">
                <li class="submenu">
                    ...
                    <ul>
                        <li><a href="{{ route('manager.home') }}" ><img src="{{ URL::asset('/assets/img/icons/dashboard.svg')}}" alt="img"><span> Dashboard</span> </a></li>
                        <li class="submenu">
                ...
                <li class="submenu-open">
                    ...
                    <ul>
                        <li class="{{ Request::is('index','index-two') ? 'active' : '' }}" >
                            <a href="{{ route('manager.home') }}"><i data-feather="grid"></i><span>Dashboard</span></a>
                        </li>
