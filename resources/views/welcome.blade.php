        ...
        <div class="container my-5">
            <div class="row justify-content-between text-center text-md-left">
                <div data-aos="fade-right" data-aos-duration="1000" data-aos-once="true" class="col-md-6">
                    <h2 class="font-weight-bold">Integration Capabilities</h2>
                    <p class="my-4">The system can integrate with other business tools and systems, such as accounting software or e-commerce platforms,
                        to streamline data flow and avoid manual data entry duplication.</p>
